...
//  char errorBuffer[27];
//
//  char txBuffer[80];	/* Print number of errors in initialisation */
//  sprintf(errorBuffer, "Number of init errors: %u\n\r", errors);
//  CDC_Transmit_FS((uint8_t *) errorBuffer, strlen(errorBuffer));
